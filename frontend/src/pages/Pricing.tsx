import { Box, Button, Card, Container, Flex, Grid, Heading, Text, Separator } from "@radix-ui/themes";
    ...
    <div className="min-h-screen bg-white">
      <div className="relative z-10">
        ...
        <Container size="4" className="py-20 px-4">
          <Flex direction="column" align="center" gap="4" className="mb-16 text-center">
            <Heading size="8" className="font-bold tracking-tight">
              Pay as you go
            </Heading>
            <Text size="4" color="gray" className="max-w-2xl">
              Purchase credits and use them for video generation or image enhancement.
              Credits never expire.
            </Text>
            <Flex gap="6" mt="4" className="border border-gray-200 px-6 py-3 rounded-lg bg-white shadow-sm">
              <Flex gap="2" align="center">
                <Video size={16} />
                <Text size="2" weight="medium">1 Video = 10 Credits</Text>
              </Flex>
              <Separator orientation="vertical" size="2" />
              <Flex gap="2" align="center">
                <Sparkles size={16} />
                <Text size="2" weight="medium">1 Image Enhancement = 1 Credit</Text>
              </Flex>
            </Flex>
          </Flex>

          <Grid columns={{ initial: "1", sm: "1", md: "3" }} gap="6" width="auto">
            {/* Free Trial */}
            <Card size="3" className="p-6 relative overflow-hidden">
              <Flex direction="column" height="100%" gap="5">
                <Box>
                  <Heading size="4" mb="2">Free Trial</Heading>
            ...
            {/* Starter Pack */}
            <Card size="3" className="p-6 relative overflow-hidden border-2 border-black">
              <div className="absolute top-0 right-0 bg-black text-white text-xs font-bold px-3 py-1 rounded-bl-lg">
                POPULAR
              </div>
              <Flex direction="column" height="100%" gap="5">
                <Box>
                  <Heading size="4" mb="2">Starter Pack</Heading>
                  <Flex align="baseline" gap="1">
            ...
            <Card size="3" className="p-6 relative overflow-hidden">
              <Flex direction="column" height="100%" gap="5">
                <Box>
                  <Heading size="4" mb="2">Pro Pack</Heading>
                  <Flex align="baseline" gap="1">
