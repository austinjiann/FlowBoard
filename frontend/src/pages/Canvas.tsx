import { Tldraw, Editor, DefaultQuickActions, DefaultQuickActionsContent, TldrawUiMenuItem, useTools } from "tldraw";
...
const GitHubButton = () => {
  return (
    <button
      onClick={() => window.open("https://github.com/austinjiann/flowboard", "_blank")}
